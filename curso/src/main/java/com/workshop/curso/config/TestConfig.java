...
import com.workshop.curso.repository.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2019-05-20T19:53:01Z"), OrderStatus.PAID, u1);
		Order o2 = new Order(null, Instant.parse("2020-02-10T19:53:01Z"), OrderStatus.WAITING_PAYMENT, u2);
		Order o3 = new Order(null, Instant.parse("2020-02-10T19:53:01Z"), OrderStatus.WAITING_PAYMENT, u1);
